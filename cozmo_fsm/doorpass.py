...
class GoToWall(StateNode):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Fri Nov 17 17:13:54 2017:
...
class WallPilotToPose(StateNode):
    ...
    class Think(StateNode):
        def start(self,event=None):
            ...
            xd = self.parent.pose.position.x
            yd = self.parent.pose.position.y
    ...
    class Fin(PilotToPose):
        ...
        def start(self, event=None):
            self.target_pose = self.parent.pose
            super().start(event)
    ...
    def setup(self):
        """
            ...
            end: self.Fin() =C=> Say("Done") =C=> ParentCompletes()
        """
        ...
        completiontrans36 .add_sources(end) .add_destinations(say2)
        
        completiontrans37 = CompletionTrans() .set_name("completiontrans37")
        completiontrans37 .add_sources(say2) .add_destinations(parentcompletes3)
